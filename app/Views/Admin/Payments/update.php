...
<?= form_open('Admin/Payments/saveUpdate', 'id="payment_form" class="random_class"') ?>
...
<div class="field is-horizontal">
  ...
  <div class="field-body">
    <div class="field">
      <input readonly class="input is-success" type="text" id="customer_name" name="customer_name" value="<?= esc($payment->customer_name) ?>">
    </div>
  </div>
</div>
...
<div class="field is-horizontal">
  ...
  <div class="field-body">
    <div class="field">
      <p class="control is-expanded">
        <input class="input is-success" type="text" id="notes" name="notes" value="<?=esc($payment->notes) ?>">
      </p>
    </div>
  </div>
</div>
