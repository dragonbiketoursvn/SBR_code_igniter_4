...
<?= $this->section('title') ?>View All Items<?= $this->endSection() ?>
...
<?php foreach ($items as $item) : ?>
  <div class="photoSection" data-box="<?= $item->box ?>" data-category_english="<?= $item->category_english ?>" data-description_english="<?= $item->description_english ?>" data-category_vietnamese="<?= $item->category_vietnamese ?>">
    <!-- <div style="display: inline-block;">
      penis
    </div> -->
    <!-- <dl>
      <dt><b>category: kitchen utensils</b></dt>
      <dd>description: rubber molds</dd>
      <dt><b>category: kitchen utensils</b></dt>
      <dd>description: rubber molds</dd>
    </dl> -->
    <form action="">
    ...
    <div class="photoBox" data-image="unloaded">
      <div class="photoCaption"><?= $item->box ?></div>
      <img class="photoImage" src="<?= site_url('Admin/HouseholdItems/displayPhoto/') . $item->photo ?>">
    </div>
  </div>
<?php endforeach; ?>
