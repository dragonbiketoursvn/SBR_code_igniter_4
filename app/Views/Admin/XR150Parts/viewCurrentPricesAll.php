...
<body>
  ...
  <table id="displayTable">
    ...
    <?php foreach ($currentPrices as $currentPrice) : ?>
      <tr>
        <td class="column1"><?= $currentPrice->code ?></td>
        <td class="column2"><?= $currentPrice->part_name ?></td>
        <td class="column3"><?= $currentPrice->price_usd ?></td>
        <td class="column4"><?= $currentPrice->price_vnd ?></td>
        <td class="column5"><?= $currentPrice->supplier_name ?></td>
        <td class="column6"><?= $currentPrice->date ?></td>
      </tr>
    <?php endforeach; ?>
