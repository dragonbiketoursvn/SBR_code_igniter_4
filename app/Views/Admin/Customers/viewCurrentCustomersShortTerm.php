...
<body>
  ...
  <table id="displayTable">
    <tr id="filterRow">
      ...
      <th>Start City</th>
      <th>Finish City</th>
      <th data-column="column6">Additional Services?</th>
      <th data-column="column7">Service Complete?</th>
    ...
    <?php foreach ($customers as $customer) : ?>
      <tr>
        ...
        <td class="column2"><?= $customer->current_bike; ?></td>
        <td class="column3"><?= $customer->rent; ?></td>
        <td class="column4"><?= $customer->start_date; ?></td>
        <td class="column5"><?= $customer->finish_date; ?></td>
        <td><?= $customer->start_city; ?></td>
        <td><?= $customer->finish_city; ?></td>
        <td class="column6"><?= $customer->additional_items_services; ?></td>
        <td class="column7"><?= $customer->service_complete; ?></td>
        <td>
