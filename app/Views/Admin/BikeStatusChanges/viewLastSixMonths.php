...
<body>
  ...
  <table id="displayTable">
    <tr id="filterRow">
      <th data-column="column1">Date</th>
      <th data-column="column2">Plate Number</th>
      <th data-column="column3">New Status</th>
      <th data-column="column4" class="date">Customer ID</th>
      <th data-column="column5" class="date">Temporary?</th>
      <th data-column="column8">Edit</th>
    </tr>

    <?php foreach ($records as $record) : ?>
      <tr>
        <td class="column1"><?= $record->date_time; ?></td>
        <td class="column2"><?= $record->plate_number; ?></td>
        <td class="column3"><?= $record->new_status; ?></td>
        <td class="column4"><?= $record->customer_id; ?></td>
        <td class="column5"><?= $record->temporary; ?></td>
        <td>
          <?= form_open(site_url('Admin/bikeStatusChanges/viewInfo')); ?>
